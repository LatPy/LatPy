...
def frac_deep_lll(basis: np.ndarray[int], a: int = 99, b: int = 100) -> np.ndarray[int]:
    """Performs Deep LLL reduction on a basis with given a and b without floating point arithemetics.

    Args:
        basis (np.ndarray[int]): The input basis
        a (int, optional): num of reduction parameter for Lovasz condition. Defaults to 99.
        b (int, optional): den of reduction parameter for Lovasz condition. Defaults to 100.
    ...
    lib.fracDeepLLL(basis_ptr, a, b, n, m)
