...
print(C.deep_lll(eta=0.5, gamma=50)[0].is_deep_lll(0.99))
print("L2 reduced:")
print(C.l2(eta=0.5))
...
print(C.qr_deep_lll(eta=0.5, gamma=50)[0].is_deep_lll(0.99))
print("DeepL2 reduced:")
print(C.deep_l2(eta=0.5, gamma=50))
print(C.deep_l2(eta=0.5, gamma=50)[0].is_deep_lll(0.99))
